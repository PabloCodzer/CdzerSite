...
<div class="row">
    <div class="col-sm-10 container-fluid mt-5" style="background-color: white">
    <h2 class="col-sm-9 my-2"> Tabela de cadastros. </h2>
    <table id="registros" class="display nowrap" cellspacing='10' style="width:100%">
        <thead>
            <tr>
                <th>Name</th>
                <th>Position</th>
