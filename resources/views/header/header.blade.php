...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon"  type="image/png" href="itens/hc.png">
        <title>CODZER</title>

        <!-- Fonts -->
        <link href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700&display=swap" rel="stylesheet">
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
        <script src="https://kit.fontawesome.com/52affb2966.js" crossorigin="anonymous"></script>
        <!-- Styles -->
        <style>
   ...
   *{
    ...
    <header class="header">
        <nav class="navbar navbar-expand-md">
          <a class="links-ft" href="/inicio"> 
              <img class="logo" type="image/png" src="itens/Codzerlogo.png" alt="codzer">
            </a>
